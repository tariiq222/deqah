...
const securityHeaders = [
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' https://cdn.moyasar.com https://*.moyasar.com https://static.cloudflareinsights.com",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
      "img-src 'self' data: blob: https:",
      "font-src 'self' data: https://fonts.gstatic.com",
      "connect-src 'self' https://*.deqah.net https://api.deqah.net https://*.moyasar.com https://cloudflareinsights.com https://errors.webvue.pro",
